...
**Pay:** $18-$23/HR. Based on experience 
...
* Enter and maintain data in company systems
* Process invoices, receipts, and basic bookkeeping
  tasks as directed
* Prepare reports, spreadsheets, and summaries for
  management as needed
* Maintain a clean, organized, and efficient office
  environment
...
* Proficiency with basic computer programs (Microsoft
  Office, email platforms, spreadsheets, etc.)
* Comfortable working in a fast‑paced environment with
  shifting priorities
* Strong problem‑solving skills and the ability to work
  independently when needed
* Dependable, punctual, and committed to maintaining
  confidentiality
